...
class EmbyIdentifyScreen extends ConsumerStatefulWidget {
  const EmbyIdentifyScreen({
  ...
  @override
  ConsumerState<EmbyIdentifyScreen> createState() => _EmbyIdentifyScreenState();
}

class _EmbyIdentifyScreenState extends ConsumerState<EmbyIdentifyScreen> {
  ...
  List<EmbyRemoteSearchResult>? _results;
  String? _error;
  ...
  Future<void> _search() async {
    final client = ref.read(embyClientProvider(widget.instance)).value;
    ...
    try {
      ...
      final info = EmbyRemoteSearchInfo(
  ...
  Future<void> _apply(EmbyRemoteSearchResult result) async {
    final client = ref.read(embyClientProvider(widget.instance)).value;
    if (client == null) return;
