...
class _SonarrReleaseSearchScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final AsyncValue<List<SonarrRelease>> releasesValue =
        ref.watch(sonarrReleasesProvider((widget.instance, widget.episode.id)));
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: <Widget>[
            ...
            Text(
              '$epCode • ${widget.episode.title ?? "Episode ${widget.episode.episodeNumber}"}',
        ...
        children: <Widget>[
          ...
          Expanded(
            child: RefreshIndicator(
              onRefresh: () async => ref.invalidate(sonarrReleasesProvider(
                (widget.instance, widget.episode.id),
              )),
              child: AsyncValueView<List<SonarrRelease>>(
                value: releasesValue,
                onRetry: () => ref.invalidate(sonarrReleasesProvider(
                  (widget.instance, widget.episode.id),
                )),
                loading: Center(
                  child: Padding(
                      ...
                      return _ReleaseTile(
                        ...
                        onGrabbed: () {
                          ...
                          ref.invalidate(sonarrEpisodesProvider(
                            (widget.instance, widget.episode.seriesId),
                          ));
